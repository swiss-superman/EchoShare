...
EchoShare is a civic sustainability MVP for reporting and coordinating action on pollution near lakes, rivers, beaches, ponds, canals, and wetlands.

It is a coded product first:

- Geo-tagged pollution reporting with photo uploads
- Free interactive map with marker and hotspot rendering
- Google login only
- Community updates and cleanup coordination
- Stakeholder directory
- Gemini-powered AI enrichment stored separately from user evidence
- n8n integration points for alerts and digests, without moving core app logic into automation
...
- PostgreSQL
- Prisma 6.19
- NextAuth.js (`next-auth`) with Google OAuth
...
The Google client JSON already present in the workspace is a web client, which is correct for this app.
